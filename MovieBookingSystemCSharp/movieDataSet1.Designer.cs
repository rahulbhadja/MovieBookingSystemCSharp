...
namespace MovieBookingSystemCSharp {
    ...
    public partial class movieDataSet1 : global::System.Data.DataSet {
        ...
        public partial class foodDataTable : global::System.Data.TypedTableBase<foodRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public foodRow AddfoodRow(string type, string f_name, string amnt) {
        ...
        public partial class foodRow : global::System.Data.DataRow {
            ...
            public string f_name {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'f_name\' in table \'food\' is DBNull.", e);
                    }
                }
                set {
            ...
            public string amnt {
                get {
                    try {
                        return ((string)(this[this.tablefood.amntColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'amnt\' in table \'food\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablefood.amntColumn] = value;
                }
            }
            ...
            public bool IsamntNull() {
                return this.IsNull(this.tablefood.amntColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetamntNull() {
                this[this.tablefood.amntColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace MovieBookingSystemCSharp.movieDataSet1TableAdapters {
    ...
    public partial class foodTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[food] WHERE (([Id] = @Original_Id) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_f_name = 1 AND [f_name] IS NULL) OR ([f_name] = @Original_f_name)) AND ((@IsNull_amnt = 1 AND [amnt] IS NULL) OR ([amnt] = @Original_amnt)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[food] ([type], [f_name], [amnt]) VALUES (@type, @f_name, @amnt" +
                ");\r\nSELECT Id, type, f_name, amnt FROM food WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[food] SET [type] = @type, [f_name] = @f_name, [amnt] = @amnt WHERE (([Id] = @Original_Id) AND ((@IsNull_type = 1 AND [type] IS NULL) OR ([type] = @Original_type)) AND ((@IsNull_f_name = 1 AND [f_name] IS NULL) OR ([f_name] = @Original_f_name)) AND ((@IsNull_amnt = 1 AND [amnt] IS NULL) OR ([amnt] = @Original_amnt)));
SELECT Id, type, f_name, amnt FROM food WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, type, f_name, amnt FROM dbo.food";
        ...
        public virtual int Fill(movieDataSet1.foodDataTable dataTable) {
        ...
        public virtual movieDataSet1.foodDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            movieDataSet1.foodDataTable dataTable = new movieDataSet1.foodDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(movieDataSet1.foodDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_type, string Original_f_name, string Original_amnt) {
        ...
        public virtual int Insert(string type, string f_name, string amnt) {
            if ((type == null)) {
        ...
        public virtual int Update(string type, string f_name, string amnt, int Original_Id, string Original_type, string Original_f_name, string Original_amnt, int Id) {
            if ((type == null)) {
            ...
            if ((amnt == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(amnt));
            }
            ...
            if ((Original_amnt == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((string)(Original_amnt));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string type, string f_name, string amnt, int Original_Id, string Original_type, string Original_f_name, string Original_amnt) {
            return this.Update(type, f_name, amnt, Original_Id, Original_type, Original_f_name, Original_amnt, Original_Id);
        }
    }
